...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        obs_batch, acs_batch, rews_batch, next_obs_batch, terminals_batch = [], [], [], [], []
        for i in batch_idx:
        ...
        assert len(obs_batch) == len(acs_batch) == len(rews_batch) == len(next_obs_batch) == len(terminals_batch) == batch_size
