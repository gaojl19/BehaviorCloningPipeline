...
if __name__ == "__main__":
    for task in HARD_MT10_CLS_DICT.keys():
        print(task)
        plot_task(n_modules=2, n_layers=2, path="./test/mt10_hard_2_2_256_dpModule_random_fixed/", name = task)
        generate_gif("./test/mt10_hard_2_2_256_dpModule_random_fixed/", task)
