...
class BC_Trainer(object):
    ...
    def __init__(self, args, params):
        ...
        self.args = args
        self.args['agent_class'] = BCAgent ## HW1: you will modify this
        ...
        # RL TRAINER
        self.rl_trainer = RL_Trainer(env = self.env, env_cls = cls_dicts, env_args = [params["env"], cls_args, params["meta_env"]], args = self.args, params = params) ## HW1: you will modify this
        
        # LOAD EXPERT POLICY
        print('Loading expert policy from...', self.args['expert_policy_file'])
        self.loaded_expert_policy = LoadedGaussianPolicy(env=self.env, params=params, args=self.args)
